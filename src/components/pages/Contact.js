    ...
    <div>
      <div className="container p-3 pb-3 mb-5 mt-3 bg-success">
        <div className="row px-3">
          <div className="col-xs-12 text-light"></div>
          <h4 className="mt-3">Let's Get Connected!</h4>
          <p>
            Catch me on <a href="https://www.linkedin.com/in/brenna-mcleod/" alt="McLeod LinkedIn Link" className="text-light">LinkedIn</a>
                or take a look at my <a href="https://github.com/bmcleod12" alt="McLeod GitHub link" className="text-light">GitHub</a>.
              </p>
          ...
          <div className="row">
            <div className="col-xs-4 p-4 ms-1">
